...
\____|__  /__|_ \
        \/     \/
\033[1;95m|| Created By Asim
\033[1;94m|| Github.com/Asim
\033[0;91mv2.0  \033[0m|| Facebook.Asim khan'''
...
def cek_ingfo(kontol):
    ...
    try:
    	...
    	hwhs = '%s-%s'%(M,N)
    print ' [*] username Ak  : %s'%(hwhs);time.sleep(0.03)
    try:
    	asu = x['id'  ]
    except (KeyError, IOError):
    	asu = '%s-%s'%(M,N)
